---
layout: page
title: To start working with Slick right away, there’s a couple of CDN choices availabile to serve the files as close, and fast as possible to your users
permalink: /about/
---
